...
/*    */     implements IMessageHandler<InfernalParticleMessage, IMessage>
/*    */   {
...
/*    */       
/* 56 */       for (int i = 0; i <= message.amount; i++) {
/* 57 */         float r = 0.9F + (float)Math.random() * 0.1F;
/* 58 */         float g = 0.1F + (float)Math.random() * 0.15F;
/* 59 */         float b = 0.0F;
/* 60 */         float s = 0.4F + (float)Math.random() * 0.4F;
/* 61 */         float m = 0.5F;
...
/* Location:              C:\Users\antro\Documents\forgottenRelicsDeobfuscated.jar!\com\integral\forgottenrelics\packets\InfernalParticleMessage.class
